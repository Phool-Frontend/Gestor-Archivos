...
ON
    archivos.id_categoria = categorias.id_categoria AND archivos.id_usuario = '$idUsuario'";
            ...
            <div class="table-responsive">
                    <table class="table table-hover table-dark" id="tablaGestorDataTable">
                        ...
                        <?php
                            ...
                            */
                            $extensionesValidas = array('png','jpg','pdf','mp3','mp4','xlsx','docx');
                        ?>
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo $rutaDescarga; ?>"
                                         download="<?php echo $nombreArchivo;  ?>" class="btn btn-success ntm-sm">
